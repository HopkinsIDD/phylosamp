---
title: <font size="5"> Tracking variants of concern - worked example </font>
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{V6: Tracking variants of concern: worked example}
...
vartrack_cod_ratio(alpha_v1=0.25, alpha_v2=0.3, beta_a=0.1, beta_s=0.5)

# Least conservative scenario assuming lower testing rate:
vartrack_cod_ratio(alpha_v1=0.25, alpha_v2=0.3, beta_a=0.05, beta_s=0.4)

# Most conservative scenario assuming higher testing rate:
vartrack_cod_ratio(alpha_v1=0.45, alpha_v2=0.3, phi_v1=0.9, phi_v2=0.95,
                   beta_a=0.1, beta_s=0.5)

# Most conservative scenario assuming lower testing rate:
vartrack_cod_ratio(alpha_v1=0.45, alpha_v2=0.3, phi_v1=0.9, phi_v2=0.95,
                   beta_a=0.05, beta_s=0.4)
...
vartrack_samplesize_detect(prob=0.75, p_v1=0.01, p0=1/10000, r=0.1,
                           omega=0.8, c_ratio=1.059, sampling_freq="cont")

# Least conservative scenario with high initial prevalence:
vartrack_samplesize_detect(prob=0.75, p_v1=0.01, p0=1/1000, r=0.1,
                           omega=0.8, c_ratio=1.059, sampling_freq="cont")

# Most conservative scenario with low initial prevalence:
vartrack_samplesize_detect(prob=0.95, p_v1=0.01, p0=1/10000, r=0.2,
                           omega=0.8, c_ratio=0.779, sampling_freq="cont")

# Most conservative scenario with high initial prevalence:
vartrack_samplesize_detect(prob=0.95, p_v1=0.01, p0=1/1000, r=0.2,
                           omega=0.8, c_ratio=0.779, sampling_freq="cont")
...
# Most conservative scenario with low initial prevalence
vartrack_prob_detect(n=28, p_v1=0.01, p0=1/10000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")

# Most conservative scenario with high initial prevalence
vartrack_prob_detect(n=28, p_v1=0.01, p0=1/1000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")
...
# Most conservative scenario with low initial prevalence
vartrack_prob_detect(n=28, p_v1=0.02, p0=1/10000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")

# Most conservative scenario with high initial prevalence
vartrack_prob_detect(n=28, p_v1=0.02, p0=1/1000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")

## DETECTION BEFORE REACHING 5% PREVALENCE

# Most conservative scenario with low initial prevalence
vartrack_prob_detect(n=28, p_v1=0.05, p0=1/10000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")

# Most conservative scenario with high initial prevalence
vartrack_prob_detect(n=28, p_v1=0.05, p0=1/1000, r=0.2,
                     omega=0.8, c_ratio=0.779, sampling_freq="cont")
