---
title: <font size="5"> Estimating sample size for transmission linkage from the false discovery rate </font>
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{L2: Estimating sample size for transmission linkage from the false discovery rate}
...
translink_samplesize(eta=0.99, chi=0.995, N=100, R=1, phi=0.75, min_pairs=30)
...
translink_samplesize(eta=0.99, chi=0.995, N=100, R=1, phi=0.95)
...
translink_tdr(eta=0.99, chi=0.995, rho=1, M=100, R=1)
