...
obs_pairs_mtsl <- function(chi, eta, rho, M, R) {
    lifecyle::deprecate_soft("1.0.0", "obs_pairs_mtsl()", "translink_expected_links_obs_mtsl()")
    lifecyle::deprecate_soft("1.0.0", "obs_pairs_mtsl(eta)", "translink_expected_links_obs_mtsl(sensitivity)")
    lifecyle::deprecate_soft("1.0.0", "obs_pairs_mtsl(chi)", "translink_expected_links_obs_mtsl(specificity)")
