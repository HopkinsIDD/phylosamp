...
prob_trans_mtsl <- function(chi, eta, rho, M, R) {
    lifecyle::deprecate_soft("1.0.0", "prob_trans_mtsl()", "translink_prob_transmit_mtsl()")
    lifecyle::deprecate_soft("1.0.0", "prob_trans_mtsl(eta)", "translink_prob_transmit_mtsl(sensitivity)")
    lifecyle::deprecate_soft("1.0.0", "prob_trans_mtsl(chi)", "translink_prob_transmit_mtsl(specificity)")
