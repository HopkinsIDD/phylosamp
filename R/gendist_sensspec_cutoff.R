...
gendist_sensspec_cutoff <- function(cutoff, mut_rate, mean_gens_pdf, max_link_gens = 1,
    ...
    gendist <- gendist_distribution(mut_rate = mut_rate, mean_gens_pdf = mean_gens_pdf,
