...
vartrack_samplesize_detect_cont <- function(prob, t = NA, p_v1 = NA, omega, p0_v1, r_v1, c_ratio = 1) {
  ...
  n <- -(log(1 - prob)) / (varfreq_cdf_logistic(t, p0_v1, r_v1, c_ratio) - varfreq_cdf_logistic(0, p0_v1, r_v1, c_ratio))
  n_samples <- n / omega
  return(n_samples)
}