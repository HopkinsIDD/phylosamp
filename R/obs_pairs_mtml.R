...
obs_pairs_mtml <- function(chi, eta, rho, M, R) {
    lifecycle::deprecate_soft("1.0.0", "obs_pairs_mtml()", "translink_expected_links_obs_mtml()")
    lifecycle::deprecate_soft("1.0.0", "obs_pairs_mtml(eta)", "translink_expected_links_obs_mtml(sensitivity)")
    lifecycle::deprecate_soft("1.0.0", "obs_pairs_mtml(chi)", "translink_expected_links_obs_mtml(specificity)")
